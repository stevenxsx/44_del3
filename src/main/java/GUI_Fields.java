...
public class GUI_Fields {
    public static GUI_Field[] makeGUIFields() {
        ...
        int i = 0;
        fields[i++] = new GUI_Start("Start", "Modtag M2 fra Banken, hver gang passerer eller lander på START", "", Color.WHITE, Color.BLACK);
        ...
        fields[i++] = new GUI_Street("SLIKBUTIKKEN", "", "", "1M", Color.WHITE, Color.BLACK);
        fields[i++] = new GUI_Street("ISKIOSKEN", "", "", "1M", Color.WHITE, Color.BLACK);
        fields[i++] = new GUI_Jail("default", "gå I FÆNGSEL", "PÅ BESØG", "", Color.WHITE, Color.BLACK);
        ...
        fields[i++] = new GUI_Jail("default", "I FÆNGSEL", "PÅ BESØG", "", Color.WHITE, Color.BLACK);
